...
export const setupLibraryExternal = (
  ...
  const staticTargets: Target[] = [
    ...
    {
      src: "./node_modules/@flow-dev/components/dist/halo-components.iife.js",
      dest: "assets/components",
      rename: `components.[hash].js`,
    },
    {
      src: "./node_modules/@flow-dev/api-client/dist/index.iife.js",
      dest: "assets/api-client",
      rename: `api-client.[hash].js`,
    },
    {
      src: "./node_modules/@flow-dev/console-shared/dist/index.iife.js",
      dest: "assets/console-shared",
      rename: `console-shared.[hash].js`,
    },
    {
      src: "./node_modules/@flow-dev/richtext-editor/dist/rich-text-editor.iife.js",
      dest: "assets/editor",
