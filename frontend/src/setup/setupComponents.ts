import { vClosePopper, VLoading, vTooltip } from "@flow-dev/components";
...
export function setupComponents(app: App) {
  ...
  // @deprecated
  // Will be removed in the future, please use the VDropdown component from @flow-dev/components.
