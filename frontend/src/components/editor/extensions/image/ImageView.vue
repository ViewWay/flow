...
import { IconImageAddLine, VButton } from "@flow-dev/components";
import type { AttachmentSimple } from "@flow-dev/console-shared";
import { type NodeViewProps } from "@flow-dev/richtext-editor";
